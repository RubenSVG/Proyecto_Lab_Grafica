...
float rot = 0.0f; //rotación de la puerta de entrada 
int bandera = 1; //Bandera para el sentido de la puerta de entrada
int bandera_puertas = 1; //Bandera para puertas de la alacena
float rot_puertas = 0.0f; //rotacion de las puertas de la alacena 
//Variable para mover las animaciones automaticamente
...
//Variables incremento de las animaciones 
float puertas = 0.0f;
...
void KeyCallback(GLFWwindow* window, int key, int scancode, int action, int mode)
{
	...
	if (keys[GLFW_KEY_L])//Animacion de las luces 
	{
		if (!anim)
		{
			//
